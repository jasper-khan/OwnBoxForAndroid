...
object Key {
    ...
    const val ROUTE_RESOLVE_MATCH_ONLY = "routeResolveMatchOnly"
    const val ROUTE_RESOLVE_STRATEGY = "routeResolveStrategy"
    const val ROUTE_RESOLVE_SERVER = "routeResolveServer"
    const val ROUTE_RESOLVE_TIMEOUT = "routeResolveTimeout"
    const val ROUTE_RESOLVE_DISABLE_CACHE = "routeResolveDisableCache"
    const val ROUTE_RESOLVE_DISABLE_OPTIMISTIC_CACHE = "routeResolveDisableOptimisticCache"
